# Overarching validations
### VAL-000a: Clock speed coverage {#val-000a}
Every functional test in test.py is parametrized over 100 kHz, 400 kHz and 1 MHz bus speeds. The entire suite passing at all three speeds validates correct operation across the I2C speed range.
**Validates:** [REQ-009](specification.md#req-009)

### VAL-000b: Bit ordering and open-drain behaviour {#val-000b}
All read and write tests exchange known byte values and verify them exactly. Any deviation in MSB-first ordering would corrupt every transferred value, and any active-high driving of SDA would cause bus contention in the open-drain harness model. The suite passing therefore validates these properties implicitly.
**Validates:** [REQ-007](specification.md#req-007), [REQ-008](specification.md#req-008)




# Protocol conformance validations
### VAL-001: Write address acknowledgement and state transition {#val-001}
...
**Validates:** [REQ-001](specification.md#req-001), [REQ-006](specification.md#req-006)

### VAL-002: Read address acknowledgement and state transition {#val-002}
...
**Validates:** [REQ-001](specification.md#req-001), [REQ-006](specification.md#req-006), [REQ-013](specification.md#req-013)

### VAL-003: Foreign address rejection {#val-003}
...
### VAL-004: Single register write {#val-004}
...
**Validates:** [REQ-001](specification.md#req-001), [REQ-006](specification.md#req-006), [REQ-011](specification.md#req-011), [REQ-004](specification.md#req-004)

### VAL-005: Write-then-read roundtrip with repeated START {#val-005}
...
**Validates:** [REQ-005](specification.md#req-005), [REQ-011](specification.md#req-011), [REQ-013](specification.md#req-013), [REQ-004](specification.md#req-004)




# Register architecture
### VAL-006: Bulk write with address auto-increment {#val-006}
...
**Validates:** [REQ-011](specification.md#req-011), [REQ-012](specification.md#req-012)

### VAL-007: Bulk read with address auto-increment {#val-007}
**Test:** ```test_bulk_read```  
...
**Validates:** [REQ-012](specification.md#req-012), [REQ-013](specification.md#req-013)

### VAL-008: Cross-block address decoding and isolation {#val-008}
...
**Validates:** [REQ-010](specification.md#req-010), [REQ-014](specification.md#req-014), [REQ-016](specification.md#req-016)

### VAL-009: Unmapped address access {#val-009}
...
**Validates:** [REQ-017](specification.md#req-017), [REQ-018](specification.md#req-018)

### VAL-010: Block B read-only behaviour {#val-010}
...
### VAL-011: LFSR activity on Block B {#val-011}
...
**Validates:** [REQ-020](specification.md#req-020)

### VAL-012: All Block B registers are serviced {#val-012}
...
**Validates:** [REQ-021](specification.md#req-021)

### VAL-013: Block A is unaffected by LFSR activity {#val-013}
...
**Validates:** [REQ-022](specification.md#req-022)




# Stress tests
### VAL-014: Consistency under repeated bulk reads {#val-014}
...
**Validates:** [REQ-026](specification.md#req-026), [REQ-027](specification.md#req-027), [REQ-020](specification.md#req-020)

### VAL-015: Consistency under mixed read/write sequences {#val-015}
...
**Validates:** [REQ-026](specification.md#req-026), [REQ-028](specification.md#req-028)