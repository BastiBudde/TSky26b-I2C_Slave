...
### VAL-000b: Bit ordering and open-drain behaviour
<a name="val-000b"></a>
...
### VAL-001: Write address acknowledgement and state transition
<a name="val-001"></a>
...
### VAL-002: Read address acknowledgement and state transition
<a name="val-002"></a>
...
### VAL-003: Foreign address rejection
<a name="val-003"></a>
...
### VAL-005: Write-then-read roundtrip with repeated START
<a name="val-005"></a>
...
### VAL-006: Bulk write with address auto-increment
<a name="val-006"></a>
...
### VAL-007: Bulk read with address auto-increment
<a name="val-007"></a>
**Test:** ```test_bulk_read```  
...
### VAL-008: Cross-block address decoding and isolation
<a name="val-008"></a>
...
### VAL-009: Unmapped address access
<a name="val-009"></a>
...
### VAL-010: Block B read-only behaviour
<a name="val-010"></a>
...
### VAL-011: LFSR activity on Block B
<a name="val-011"></a>
...
### VAL-012: All Block B registers are serviced
<a name="val-012"></a>
...
### VAL-013: Block A is unaffected by LFSR activity
<a name="val-013"></a>
...
# Stress tests
### VAL-014: Consistency under repeated bulk reads
<a name="val-014"></a>
...
### VAL-015: Consistency under mixed read/write sequences
<a name="val-015"></a>
