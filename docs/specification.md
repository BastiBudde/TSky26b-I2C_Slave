...
**Validated by:** (VAL-IDs to be assigned)
...
The slave shall transmit and receive all bytes most-significant-bit first, in accordance with the I²C specification.
**Validated by:** (to be assigned)
...
The slave shall operate correctly at the three standard I²C bus speeds: Standard Mode (100 kHz), Fast Mode (400 kHz), and Fast Mode Plus (1 MHz), given a system clock of 25 MHz.
**Validated by:** (to be assigned)
