...
### REQ-007: MSB-first bit ordering
<a name="req-007"></a>
...
### REQ-008: Open-drain SDA behaviour
<a name="req-008"></a>
...
### REQ-010: Register block address ranges
<a name="req-010"></a>
...
### REQ-011: Write to addressed register
<a name="req-011"></a>
...
### REQ-012: Register address auto-increment
<a name="req-012"></a>
...
### REQ-013: Read from addressed register
<a name="req-013"></a>
...
### REQ-014: Cross-block address decoding
<a name="req-014"></a>
...
### REQ-015: Block boundary integrity
<a name="req-015"></a>
...
### REQ-016: Block B is read-only from the master
<a name="req-016"></a>
...
### REQ-017: Unmapped address — no write effect
<a name="req-017"></a>
...
### REQ-018: Unmapped address — read returns zero
<a name="req-018"></a>
...
### REQ-020: LFSR drives Block B with pseudo-random data
<a name="req-020"></a>
...
### REQ-021: All Block B registers are serviced
<a name="req-021"></a>
...
### REQ-022: LFSR does not affect Block A
<a name="req-022"></a>
...
# Reset behaviour
### REQ-023: Synchronous active-low reset
<a name="req-023"></a>
...
### REQ-024: Defined state after reset
<a name="req-024"></a>
...
### REQ-025: LFSR halted during reset
<a name="req-025"></a>
...
# Robustness
### REQ-026: State recovery after every transaction
<a name="req-026"></a>
...
### REQ-027: Consistency under repeated bulk reads
<a name="req-027"></a>
...
### REQ-028: Consistency under mixed read/write sequences
<a name="req-028"></a>
